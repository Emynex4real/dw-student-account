      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {!hasEvents ? (
          ...
          <div className="flex flex-col items-center justify-center text-center py-24 bg-white rounded-3xl border border-dashed border-gray-300 shadow-sm max-w-3xl mx-auto">
            ...
            <button className="bg-black text-white font-medium py-3 px-8 rounded-xl hover:bg-gray-800 transition-colors duration-300 flex items-center gap-2">
              <Home size={18} />
              Return to Dashboard
            </button>
          </div>
                ...
                <div key={event.id} className="group bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col sm:flex-row">
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-gray-100 mt-2">
                      <button className="flex-1 bg-black text-white font-medium py-2.5 rounded-xl hover:bg-[#f7941d] hover:text-black transition-colors duration-300 flex items-center justify-center gap-2 text-sm">
                        <Ticket size={16} /> RSVP Now
                      </button>
                      <button className="px-3 py-2.5 border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center tooltip-trigger">
